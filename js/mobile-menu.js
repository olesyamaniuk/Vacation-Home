document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".t-q-navigation-list");
  const headerRef = document.querySelector(".t-q-header");
  const navigationRef = document.querySelector(".t-q-navigation");
  ...
  document.querySelectorAll(".t-q-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".t-q-toggle-button img");
